...
public class MVC_Reparaciones_Controlador {
    ...
    public MVC_Reparaciones_Controlador(MVC_TecnicoPrincipal_Vista tecnVista, MVC_Reparaciones_Modelo repModelo, MVC_ClientesR_Modelo cliMod, MVC_ClientesR_Controlador cliContr) {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (opcion.equals("Añadir")) {
                if (codCliente == 0) {
                    ...
                    Reparacion repAnadir = new Reparacion(cod_rep, problema, solucion, fechaRec, fechaEnt, codCliente, id, false);
